 ...
 *
 * CSRs have no public join flow: accounts are provisioned exclusively
 * through administrator invitation, and the invitee completes the initial
 * credential through the email verification setup path. Login is refused
 * while the CSR's email is unverified or the account has been deactivated.
 ...
 */
@Controller("auth/csr")
export class BrokerDeskActorsCsrAuthController {
  /**
